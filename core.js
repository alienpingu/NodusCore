...
app.get('/details', (req, res) => utilsGet.detailsHandler(req, res));
...
app.post('/vendors', (req, res) => utilsPost.vendorsHandler(req, res));
...
app.get('/query', (req, res) => utilsGet.queryHandler(req, res));
